termux_step_setup_variables() {
	...
	: "${TERMUX_DEBUG:="false"}"
	: "${TERMUX_PKG_API_LEVEL:="28"}" # Against Pie
	...
	TERMUX_PKG_QUICK_REBUILD=true # set this temporarily when iterating on a large package and you don't want the source and build directories wiped every time you make a mistake
