...
if [ -f $FILE ]; then
    ...
    cp -rf $TERMUX_PREFIX/include/c++/v1/* /home/builder/.termux-build/_cache/android-r${TERMUX_NDK_VERSION_NUM}${TERMUX_NDK_REVISION}-api-24-v4/sysroot/usr/include/c++/v1/
