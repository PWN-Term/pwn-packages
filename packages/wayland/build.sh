...
TERMUX_PKG_DEPENDS="libandroid-support, libffi, libxml2, libexpat, wayland-protocols"
...
termux_step_post_make_install() {
	sed -i 's/wayland_scanner=${exec_prefix}\/bin\/wayland-scanner/wayland_scanner=\/usr\/bin\/wayland-scanner/g' /data/data/hilled.pwnterm/files/usr/lib/pkgconfig/wayland-scanner.pc
}
